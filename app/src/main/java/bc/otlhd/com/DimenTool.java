...
public class DimenTool {
        ...
        try {
            ...
            while ((tempString = reader.readLine()) != null) {
                ...
                if (tempString.contains("</dimen>")) {
                    ...
                    sw480.append(start).append(num * 1.1).append(end).append("\r\n");

                    sw600.append(start).append(num * 1.2).append(end).append("\r\n");

                    sw720.append(start).append(num * 1.3).append(end).append("\r\n");

                    sw800.append(start).append(num * 1.4).append(end).append("\r\n");

                    w820.append(start).append(num * 1.5).append(end).append("\r\n");
    ...
    public static void writeFile(String file, String text) {
        ...
        try {
            ...
            out = new PrintWriter(new BufferedWriter(new FileWriter(file+"dimens.xml")));
