package bc.otlhd.com.utils.upload;
...
//    public static String UP_SAVEPATH = getSDPath() + "/Download/";// 保存apk的文件夹
    public static String UP_SAVEPATH = IssueApplication.getcontext().getExternalFilesDir(null).getAbsolutePath()+"/";// 保存apk的文件夹
    ...
    private void showUpAppDialog(String newVersionName) {
        ...
        builder.setTitle(updateMsg + newVersionName)             //标题
                .setIcon(R.mipmap.app_icon)     //icon
