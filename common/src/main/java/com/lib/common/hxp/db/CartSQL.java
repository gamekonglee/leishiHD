...
public class CartSQL {
    ...
    public static final String MARKETPRICE = "market_price";//产品的app售价
    public static final String PRICE = "price";//产品的app售价
    public static final String URL = "url";//产品的URL
    public static final  String NUM="num"; //产品的数量
    public static  final String REMARK="remark";//产品备注
    public static  final String REMARKINSTALL="remarkinstall";//产品备注
